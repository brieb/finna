	        ...
	        <?php foreach ($userCourses as $course): ?>
	        	<div id="course-info-<?= $course['id'] ?>" courseId="<?= $course['id'] ?>" class="hidden child-page detailContent">
	        	     ...
	        	     <table style="margin-top: 5px;">
	        	     	<tbody>
	        	     		<tr>
	        	     			<td colspan="2"><span class="detailTitleLabel">Description:</span><br/><div style="margin-top:5px;" class="detailText"><?= $course['description'] ?></div></td>
	        	     		</tr>
	        	     		<tr>
	        	     			<td><br/><span class="detailTitleLabel">Office Hours:</span></td>
	        				</tr>
	        	     		<tr>
	        	     			<td><br/><span class="detailTitleLabel">Announcements:</span></td>
	        	     		</tr>
	        	     	</tbody>
	        	     </table>
